...
const endpoint = 'https://api.zsubscriptions.local/county-states';

const fields = [
    { name: 'country_id', label: 'Country', type: 'select', optionsUrl: 'https://api.zsubscriptions.local/countries' },
...
<template>
    <AdminLayout>
        <h1 class="text-2xl font-semibold mb-4">Counties / States</h1>
        ...
        <table class="w-full bg-white rounded shadow">
            ...
            <tbody>
                <tr v-for="item in items" :key="item.id" class="border-b">
                    ...
                    <td class="p-3">{{ item.country?.name }}</td>
