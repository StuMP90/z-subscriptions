...
const endpoint = 'https://api.zsubscriptions.local/global-regions';
...
const remove = async (item) => {
    if (! confirm('Delete this global region?')) return;
...
<template>
    <AdminLayout>
        <h1 class="text-2xl font-semibold mb-4">Global Regions</h1>
